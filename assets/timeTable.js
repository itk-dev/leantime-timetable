    ...
    class TimeTable {
        constructor() {
            this.activeTicketIds = new Set(
                ...
                this.viewCurrentWeek = $("input[name='timetable-current-week']").val(),
                this.viewFirstDay = $("input[name='timetable-current-week-first-day']").val(),
            );
        ...
        newTimeEntry() {
            ...
            let dateToSet = currentWeekNumber === viewWeekNumber
